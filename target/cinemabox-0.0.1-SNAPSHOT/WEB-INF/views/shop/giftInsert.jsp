...
<body>
   <div class="container">
        <main>
            <div class="container">
                <form id="insertGift" method="post" action="insertGift" enctype="multipart/form-data">
                    <div class="row">
                    <a class="navbar-brand" href="admin" style="font-size:25px; color:black; font-weight: bolder;">CINEMA BOX</a>
                        <span class="border-bottom border-1 border-dark"><strong>[GIFT] 정보 추가</strong></span>
                        <div class="col-12">
                        <br/>
                            ...
                            <!-- 숫자만 적을수 있게함 -->
                               <input type="text" onKeyup="this.value=this.value.replace(/[^0-9]/g,'')" 
								class="form-control" id="discountPrice" placeholder="할인 가격(원)" name="discountPrice" />
                                <label for="floatingInput">할인 가격(원)</label>
                            </div>
                            <h3>대표 이미지</h3> 
