				...
				<nav class="navbar">
					...
					<div style="margin-left: 30%; margin-top: 15px;"> 
						<nav aria-label="Page navigation example">
							...
							<li class="page-item"><a class="page-link" href="../notice/list?page=<%=(nowPage/5)*5 %>&searchWord=<%=searchWord%>" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
						  	 	<% 
